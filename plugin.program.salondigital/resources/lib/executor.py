...
class Main:
    ...
    def _loadPrograms(self):
        basepath = xbmc.translatePath( "special://home/addons/plugin.program.salondigital" )
        datapath = os.path.join(basepath, "update.cfg")
    ...
    def _execProgram(self):
        ...
        # xbmc.executebuiltin("Notification(Salondigital,Actualizando no apague el equipo y espere al reinicio automatico,[,5000])")
